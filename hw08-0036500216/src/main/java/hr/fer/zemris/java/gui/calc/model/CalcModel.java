...
public interface CalcModel {
	/**
	 * Prijava promatrača koje treba obavijestiti kada se promijeni vrijednost
	...
	/**
	 * Odjava promatrača s popisa promatrača koje treba obavijestiti kada se
	...
	/**
	 * Vraća tekst koji treba prikazati na zaslonu kalkulatora. Detaljnija
	 * specifikacija dana je u uputi za domaću zadaću.
	 * 
	...
	/**
	 * Upisuje decimalnu vrijednost u kalkulator. Vrijednost smije biti i beskonačno
	 * odnosno NaN. Po upisu kalkulator postaje needitabilan.
	 * 
	...
	/**
	 * Vraća informaciju je li kalkulator editabilan (drugim riječima, smije li
	 * korisnik pozivati metode {@link #swapSign()}, {@link #insertDecimalPoint()}
	 * te {@link #insertDigit(int)}).
	 * 
	...
	/**
	 * Resetira trenutnu vrijednost na neunesenu i vraća kalkulator u editabilno
	 * stanje.
	 */
	void clear();

	/**
	 * Obavlja sve što i {@link #clear()}, te dodatno uklanja aktivni operand i
	 * zakazanu operaciju.
	 */
	void clearAll();
	 ...
	 *                                  broja, ako broj već sadrži decimalnu točku
	 *                                  ili ako kalkulator nije editabilan
	 */
	void insertDecimalPoint() throws CalculatorInputException;

	/**
	 * U broj koji se trenutno upisuje na kraj dodaje poslanu znamenku. Ako je
	 * trenutni broj "0", dodavanje još jedne nule se potiho ignorira.
	 * 
	...
	/**
	 * Metoda postavlja aktivni operand na predanu vrijednost. Ako kalkulator već
	 * ima postavljen aktivni operand, predana vrijednost ga nadjačava.
	 * 
	...
	/**
	 * Postavljanje zakazane operacije. Ako zakazana operacija već postoji, ovaj je
	 * poziv nadjačava predanom vrijednošću.
	 * 
	...
	/**
	 * Metoda koja spremi prenesu vrijednost u freeze value.
	 * 
	 * @param value
	 */
	...
	/**
	 * Metoda koja provjerava postoji li freeze value.
	 * 
	 * @return
	 */
